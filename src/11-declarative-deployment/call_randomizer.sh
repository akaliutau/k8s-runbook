...
# With Service with NodePort: use this script to find out the port and address of instance:

# Pick up service's NodePort
port=$(kubectl get svc randomizer -o jsonpath="{.spec.ports[0].nodePort}")
